	...
	<div class="col-12">
		<div class="card">
			<h4 class="card-title">
				...
				<input type="hidden" class="form-control" name="writer" value="user00" readonly="readonly">
				<input type="hidden" class="form-control" name="category" value="1" readonly="readonly">
			</h4>
...
function sendAjax(data){
	...
	return fetch("/owner/news/register",
		{method:"post",
...
function movePage(){
//	alert("movePage")
	self.location="/owner/news/notice"
}
...
/*  document.querySelector(".registerBtn").addEventListener("click",function(e){
	...
	fetch("http://192.168.0.101:8080/owner/news/register", {
		method:"post",
		body:formData
	}).then(res => res.json())
	.then(jsonObj => {
