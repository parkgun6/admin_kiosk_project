	...
	<div class="card">
		<div class="card-body">
			...
			<table class="table table-bordered">
				...
				<input type="hidden" class="form-controlInfo" name="mno" value="${menu.mno }">
				<tr>
					<th>이름</th>
				...
				<tr>
					...
					<td><textarea rows="5" class="form-control"
							name="explanation">${menu.explanation }</textarea></td>
				</tr>
				<tr>
					<th>카테고리</th>
					<td>
		...
		<div class="border-top">
			<div class="card-body">
				<button type="button" class="modBtn btn btn-primary">수정하기</button>
				<button class='removeBtn btn btn-danger' type="button">삭제하기</button>
...
<div class="picture" style="float: left;
    ...
    <img src='/owner/view?file=${attach.link }' style='width:500px;'>
    </c:if>
    </c:forEach>
    </c:forEach>
</div>
...
const mno = dqs("input[name='mno']").value;
console.log(mno);
...
function sendAjax(data){
	...
	return fetch("/owner/myshop/menu/modify",
		{method:"post",
...
document.querySelector(".modBtn").addEventListener("click", function(e){
	...
	const data = {sno:snoValue,mno:mno,name:nameValue,price:priceValue,explanation:explanationValue,fileList:arr};
...
return fetch("/owner/myshop/menu/remove",
		{
		method:'post',
